export default function Footer() {
    return (
        <>
        <div className="p-10 flex flex-col gap-8 border-t-10 border-gray-200">
            ...
            <p className="text-center text-2xl">© 2026 Kuber Grains & Spices Pvt. Ltd. All Rights Reserved.</p>
            <p className="text-center text-xl">Crafted with ❤️ to help customers discover products featured in our Instagram reels.</p>
        </>
    )
}